...
mixin _$ClinicModel {
 ...
 String get id; String get name; String get address; String? get city; double get latitude; double get longitude; String? get phone;@JsonKey(name: 'image_url') String? get imageUrl;@JsonKey(name: 'distance_meters') double get distanceMeters;@JsonKey(name: 'doctor_count') int get doctorCount;@JsonKey(name: 'rating_avg') double get ratingAvg;@JsonKey(name: 'review_count') int get reviewCount;@JsonKey(name: 'category') String? get category;@JsonKey(name: 'duration_minutes') int get durationMinutes; List<String>? get specializations;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClinicModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.distanceMeters, distanceMeters) || other.distanceMeters == distanceMeters)&&(identical(other.doctorCount, doctorCount) || other.doctorCount == doctorCount)&&(identical(other.ratingAvg, ratingAvg) || other.ratingAvg == ratingAvg)&&(identical(other.reviewCount, reviewCount) || other.reviewCount == reviewCount)&&(identical(other.category, category) || other.category == category)&&(identical(other.durationMinutes, durationMinutes) || other.durationMinutes == durationMinutes)&&const DeepCollectionEquality().equals(other.specializations, specializations));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,address,city,latitude,longitude,phone,imageUrl,distanceMeters,doctorCount,ratingAvg,reviewCount,category,durationMinutes,const DeepCollectionEquality().hash(specializations));

@override
String toString() {
  return 'ClinicModel(id: $id, name: $name, address: $address, city: $city, latitude: $latitude, longitude: $longitude, phone: $phone, imageUrl: $imageUrl, distanceMeters: $distanceMeters, doctorCount: $doctorCount, ratingAvg: $ratingAvg, reviewCount: $reviewCount, category: $category, durationMinutes: $durationMinutes, specializations: $specializations)';
}
...
@useResult
$Res call({
 String id, String name, String address, String? city, double latitude, double longitude, String? phone,@JsonKey(name: 'image_url') String? imageUrl,@JsonKey(name: 'distance_meters') double distanceMeters,@JsonKey(name: 'doctor_count') int doctorCount,@JsonKey(name: 'rating_avg') double ratingAvg,@JsonKey(name: 'review_count') int reviewCount,@JsonKey(name: 'category') String? category,@JsonKey(name: 'duration_minutes') int durationMinutes, List<String>? specializations
});
...
/// Create a copy of ClinicModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? address = null,Object? city = freezed,Object? latitude = null,Object? longitude = null,Object? phone = freezed,Object? imageUrl = freezed,Object? distanceMeters = null,Object? doctorCount = null,Object? ratingAvg = null,Object? reviewCount = null,Object? category = freezed,Object? durationMinutes = null,Object? specializations = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String address,  String? city,  double latitude,  double longitude,  String? phone, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'distance_meters')  double distanceMeters, @JsonKey(name: 'doctor_count')  int doctorCount, @JsonKey(name: 'rating_avg')  double ratingAvg, @JsonKey(name: 'review_count')  int reviewCount, @JsonKey(name: 'category')  String? category, @JsonKey(name: 'duration_minutes')  int durationMinutes,  List<String>? specializations)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClinicModel() when $default != null:
return $default(_that.id,_that.name,_that.address,_that.city,_that.latitude,_that.longitude,_that.phone,_that.imageUrl,_that.distanceMeters,_that.doctorCount,_that.ratingAvg,_that.reviewCount,_that.category,_that.durationMinutes,_that.specializations);case _:
  return orElse();
...
class _ClinicModel extends ClinicModel {
  const _ClinicModel({required this.id, required this.name, required this.address, this.city, required this.latitude, required this.longitude, this.phone, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(name: 'distance_meters') this.distanceMeters = 0.0, @JsonKey(name: 'doctor_count') this.doctorCount = 0, @JsonKey(name: 'rating_avg') this.ratingAvg = 0.0, @JsonKey(name: 'review_count') this.reviewCount = 0, @JsonKey(name: 'category') this.category, @JsonKey(name: 'duration_minutes') this.durationMinutes = 0, final  List<String>? specializations}): _specializations = specializations,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,address,city,latitude,longitude,phone,imageUrl,distanceMeters,doctorCount,ratingAvg,reviewCount,category,durationMinutes,const DeepCollectionEquality().hash(_specializations));
...
/// Create a copy of ClinicModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? address = null,Object? city = freezed,Object? latitude = null,Object? longitude = null,Object? phone = freezed,Object? imageUrl = freezed,Object? distanceMeters = null,Object? doctorCount = null,Object? ratingAvg = null,Object? reviewCount = null,Object? category = freezed,Object? durationMinutes = null,Object? specializations = freezed,}) {
