// lib/test/flutter_test_config.dart
//
...
Future<void> testExecutable() async {
  ...
  // (e.g., AuthLocalDataSource.cacheUser, HomeLocalDataSource banners cache).
  SharedPreferences.setMockInitialValues(<String, Object>{});

  // 3. Optional: setup test environment variables
  // dotenv.load(fileName: '.env.test') — tidak dipakai di MVP
}
